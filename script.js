(() => {
  ...
  const slides = [
    {
      id: "crecimiento",
      kicker: "Asesoría financiera para empresas",
      headline: "ASESORÍA",
      accent: "EMPRESARIAL",
      body: "Impulsa el capital de tu empresa con estrategia y respaldo. Tesorería, financiamiento, cobertura cambiaria y vinculación con instituciones reguladas.",
      cta: "Habla con un especialista",
      href: "#contacto",
      secondary: "Conoce las soluciones",
    ...
    },
    {
      ...
      headline: "TESORERÍA",
      accent: "ACTIVA",
      body: "Optimización de flujos de efectivo y visibilidad de caja para decidir con calma y precisión, al ritmo de tu operación.",
      cta: "Conoce tesorería",
      href: "#tesoreria",
      secondary: "Habla con un especialista",
      secondaryHref: "#contacto",
      image: "images/tesoreria.jpg",
      video: null,
    },
    {
      id: "cobertura",
      kicker: "Cobertura cambiaria",
      headline: "COBERTURA",
      accent: "CAMBIARIA",
      body: "Estrategias de protección ante la volatilidad del tipo de cambio. XP promueve y acompaña; BX+ formaliza y ejecuta.",
      cta: "Conoce cobertura",
      href: "#riesgos",
      secondary: "Habla con un especialista",
      secondaryHref: "#contacto",
  ...
  megaBtn?.addEventListener("mouseenter", () => setMega(true));
  ...
  function armTimers() {
    ...
    remain = READING;
    // freeze remaining if paused mid-way via mouseleave restart
    nextTimer._start = start;
    nextTimer._budget = budget;
  }
